...
10. [Lists & Dicts](#10-lists--dicts)
11. [String & Number Methods](#11-string--number-methods)
12. [Finding Elements](#12-finding-elements)
13. [Element Interaction](#13-element-interaction)
14. [Element Lists (ZenList)](#14-element-lists-zenlist)
15. [Browser Navigation](#15-browser-navigation)
16. [Page Inspection](#16-page-inspection)
17. [Modules](#17-modules)
18. [File System & I/O](#18-file-system--io)
19. [Web Requests (http)](#19-web-requests-http)
20. [Standard Library](#20-standard-library)
21. [Error Handling](#21-error-handling)
22. [Shell Usage](#22-shell-usage)
23. [CLI Reference](#23-cli-reference)
24. [Complete Examples](#24-complete-examples)
25. [Language Grammar](#25-language-grammar)
26. [Troubleshooting](#26-troubleshooting)
27. [Appendix: Quick Reference](#27-appendix-quick-reference)
...
statement    = let | assign | go | fill | click | wait
             ...
             | continue | try | include | block | expression
